      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-white/50 hover:text-[#F97316] transition-colors">
        ...
        <div className="mt-8 pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-sm text-white/50 hover:text-[#F97316] transition-colors">Privacy Policy</a>
            <a href="#" className="text-sm text-white/50 hover:text-[#F97316] transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
